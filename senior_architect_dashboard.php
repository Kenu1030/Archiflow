<?php
// Senior Architect Dashboard - Identical to Architect design with role change
$allowed_roles = ['senior_architect'];
include __DIR__.'/includes/auth_check.php';
$full_name = $_SESSION['full_name'];
include 'db.php';
$page_title = 'Senior Architect Dashboard';
      ...
      <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
        <div>
          <div class="inline-flex items-center px-4 py-2 bg-blue-100 text-blue-800 rounded-full text-sm font-medium mb-4">
            <i class="fas fa-drafting-compass mr-2"></i>Senior Architect Portal
          </div>
